...
timezones_data = [
    ...
    },
    {
        ...
        "desc": "San José is Costa Rica's seat of national government, focal point of political and economic activity, and major transportation hub.",
        "map": "map_san_jose.png",
        "population": 1013240,
        "subdesc": [
            "Know something cool about that place ? Contribute on git and share with other stoners!"
        ]
    },
    {
        "city": "Mexico City",
        ...
        "subdesc": [
            ...
            "Mexico City is the most visited city in the Americas.",
    ...
    },
    {
        ...
        "desc": "The capital and largest city of the Canadian province of Newfoundland and Labrador. It is on the eastern tip of the Avalon Peninsula on the island of Newfoundland.",
         "subdesc": [
            ...
            "St. John’s is the oldest post-Columbian European settlement in North America."
            "The city is named after John Cabot, the first explorer to sail into the island.",
            ]
    },
    {
        ...
        "desc": "An archipelago in the Atlantic Ocean, part of the State of Pernambuco, Brazil, and located 354km (220mi) offshore from the Brazilian coast. It consists of 21 islands and islets.",
         "subdesc": [
            "To help preserve the island’s natural landscapes and conserve the delicate ecosystem that thrives there, the number of tourists that can visit Fernando de Noronha is about 450 to 500 people per day."
            "During the Beagle five-year expedition 1830s, Charles Darwin stopped at the Fernando de Noronha islands and his observations there inspired further research there from other biologists and ecologists."
            ]
    ...
    },
    {
        ...
        "desc": "The capital and largest city of Cape Verde. It is located on Santiago Island, the largest island of the archipelago.",
         "subdesc": [
            "There are more Cape Verdeans living abroad than are in the country.",
            "It is estimated that there is one goat for every two people in Cape Verde.",
            "Cape Verde was uninhabited until the 15th century, when Portuguese explorers discovered and colonized the islands, establishing the first European settlement in the tropics."
            ]
    },
    {
        "city": "Accra",
