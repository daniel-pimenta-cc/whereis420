...
def ugc_parser(file_name: str) -> None:
    operator = []
    ugc_file = open(os.path.join(script_path, '{}.ugc'.format(file_name)), 'r', encoding='utf-8').readlines()
    new_file = open(os.path.join(script_path, '{}.json'.format(file_name)), 'w', encoding='utf-8')
    new_json = {}
